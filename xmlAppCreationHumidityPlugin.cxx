    ...
    void *endpoint_plugin_qos)
{
    try {
        char * position = NULL;
        const char *METHOD_NAME = "ResolutionPlugin_serialize";
        ...
        if(serialize_sample) {
            ...
            if (*sample != Resolution::LOW && *sample != Resolution::HIGH){
                RTICdrLog_exception(
                    METHOD_NAME, 
    ...
    void *endpoint_plugin_qos)
{
    char * position = NULL;
    DDS_Enum enum_tmp;
    const char *METHOD_NAME = "ResolutionPlugin_deserialize_sample";
    ...
    if(deserialize_sample) {
        ...
        switch (enum_tmp) {
            case Resolution::LOW:
            *sample=Resolution::LOW;
            break;
            case Resolution::HIGH:
            *sample=Resolution::HIGH;
            break;
            default:
            {
    ...
    unsigned int current_alignment)
{
    try {
        ...
        current_alignment += ResolutionPlugin_get_serialized_sample_max_size_ex(
            endpoint_data,
            NULL,
...
unsigned int ResolutionPlugin_get_serialized_sample_min_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
{  
    try {
        ...
        current_alignment += ResolutionPlugin_get_serialized_sample_max_size(
...
{
    try {
        return  ResolutionPlugin_serialize(
...
RTIBool ResolutionPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    Resolution *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
{
    try {
        return  ResolutionPlugin_deserialize_sample(
...
void ResolutionPluginSupport_print_data(
    const Resolution *sample,
    const char *description, int indent_level)
{
    ...
    RTICdrType_printEnum((RTICdrEnum *)sample, "Resolution", indent_level + 1);
}
...
{
    try {
        HumidityUnion *sample = new HumidityUnion;    
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            HumidityUnionPluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = HumidityUnionPlugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                HumidityUnionPlugin_get_serialized_sample_max_size, epd,
...
HumidityUnionPlugin_copy_sample(
    ...
    const HumidityUnion *src)
{
    return HumidityUnionPluginSupport_copy_data(dst,src);
}
    ...
    void *endpoint_plugin_qos)
{
    ...
    if(deserialize_sample) {
        ...
        if(!ResolutionPlugin_deserialize_sample(
            endpoint_data,
            &sample->_d(),
            stream,
            RTI_FALSE, RTI_TRUE,
    ...
    const HumidityUnion *sample)
{
    try{
        ...
        result = HumidityUnionPlugin_serialize(
    ...
    unsigned int length)
{
    ...
    rti::topic::reset_sample(*sample);
    return HumidityUnionPlugin_deserialize_sample( 
        NULL, sample,
    ...
    void *endpoint_plugin_qos)
{
    try {
        RTIBool result;
        const char *METHOD_NAME = "HumidityUnionPlugin_deserialize";
        if (drop_sample) {} /* To avoid warnings */

        stream->_xTypesState.unassignable = RTI_FALSE;
        result= HumidityUnionPlugin_deserialize_sample( 
...
RTIBool HumidityUnionPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    RTIBool skip_encapsulation,
    RTIBool skip_sample, 
    ...
    unsigned int current_alignment)
{
    try {
        ...
        size = HumidityUnionPlugin_get_serialized_sample_max_size_ex(
    ...
    unsigned int current_alignment)
{
    try {
        ...
        current_alignment +=ResolutionPlugin_get_serialized_sample_min_size(
    ...
    const HumidityUnion * sample) 
{
    try {  
        ...
        current_alignment += ResolutionPlugin_get_serialized_sample_size(
...
RTIBool HumidityUnionPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    HumidityUnion *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
...
RTIBool HumidityUnionPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    HumidityUnion **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
    ...
    void *endpoint_plugin_qos)
{
    try {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= HumidityUnionPlugin_deserialize_key_sample(
    ...
    unsigned int current_alignment)
{
    try {
        ...
        size = HumidityUnionPlugin_get_serialized_key_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *HumidityUnionPlugin_new(void) 
{ 
    ...
    HumidityUnionPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    HumidityUnionPlugin_destroy_sample;
    ...
    HumidityUnionPlugin_get_sample;
    ...
    HumidityUnionPlugin_get_key_kind;
    ...
    */
    ...
    &rti::topic::dynamic_type<HumidityUnion>::get().native();
    ...
    HumidityUnionPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    HumidityUnionPlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    HumidityUnionPlugin_get_serialized_sample_size;

    static const char * TYPE_NAME = "HumidityUnion";
...
void
HumidityUnionPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 

/* ----------------------------------------------------------------------------
*  Type PercisionCommand
* -------------------------------------------------------------------------- */
...
{
    try {
        PercisionCommand *sample = new PercisionCommand;    
        rti::topic::allocate_sample(*sample);
        return sample;
    } catch (...) {
        return NULL;
...
PercisionCommandPluginSupport_copy_data(
    PercisionCommand *dst,
    const PercisionCommand *src)
{
    try {
        *dst = *src;
    } catch (...) {
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            PercisionCommandPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            PercisionCommandPluginSupport_destroy_data,
            NULL , NULL );
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = PercisionCommandPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                PercisionCommandPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
...
PercisionCommandPlugin_copy_sample(
    ...
    const PercisionCommand *src)
{
    return PercisionCommandPluginSupport_copy_data(dst,src);
}
    ...
    const PercisionCommand *sample)
{
    try{
        ...
        result = PercisionCommandPlugin_serialize(
            (PRESTypePluginEndpointData)&epd, sample, &stream, 
            RTI_TRUE, RTICdrEncapsulation_getNativeCdrEncapsulationId(), 
            RTI_TRUE, NULL);  
    ...
    unsigned int length)
{
    ...
    rti::topic::reset_sample(*sample);
    return PercisionCommandPlugin_deserialize_sample( 
        NULL, sample,
        &stream, RTI_TRUE, RTI_TRUE, 
        NULL);
}
    ...
    void *endpoint_plugin_qos)
{
    try {
        RTIBool result;
        const char *METHOD_NAME = "PercisionCommandPlugin_deserialize";
        if (drop_sample) {} /* To avoid warnings */

        stream->_xTypesState.unassignable = RTI_FALSE;
        result= PercisionCommandPlugin_deserialize_sample( 
            endpoint_data, (sample != NULL)?*sample:NULL,
            stream, deserialize_encapsulation, deserialize_sample, 
            endpoint_plugin_qos);
        if (result) {
...
RTIBool PercisionCommandPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    RTIBool skip_encapsulation,
    RTIBool skip_sample, 
    ...
    unsigned int current_alignment)
{
    try {
        ...
        size = PercisionCommandPlugin_get_serialized_sample_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
    ...
    const PercisionCommand * sample) 
{
    try {  
        ...
        current_alignment += ResolutionPlugin_get_serialized_sample_size(
            endpoint_data,RTI_FALSE, encapsulation_id,
            current_alignment, &sample->requestedResolution());
    ...
    void *endpoint_plugin_qos)
{
    try {
        ...
        if(serialize_key) {
            ...
            if (!PercisionCommandPlugin_serialize(
                endpoint_data,
                sample,
                stream,
                RTI_FALSE, encapsulation_id,
...
RTIBool PercisionCommandPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    PercisionCommand *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
    ...
    void *endpoint_plugin_qos)
{
    try {
        ...
        if (deserialize_key) {
            ...
            if (!PercisionCommandPlugin_deserialize_sample(
                endpoint_data, sample, stream, 
                RTI_FALSE, RTI_TRUE, 
                endpoint_plugin_qos)) {
                return RTI_FALSE;
...
RTIBool PercisionCommandPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    PercisionCommand **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
    ...
    void *endpoint_plugin_qos)
{
    try {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= PercisionCommandPlugin_deserialize_key_sample(
            endpoint_data, (sample != NULL)?*sample:NULL, stream,
            deserialize_encapsulation, deserialize_key, endpoint_plugin_qos);
        if (result) {
            if (stream->_xTypesState.unassignable) {
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment += PercisionCommandPlugin_get_serialized_sample_max_size_ex(
        endpoint_data, overflow,RTI_FALSE, encapsulation_id, current_alignment);
    ...
    unsigned int current_alignment)
{
    try {
        ...
        size = PercisionCommandPlugin_get_serialized_key_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *PercisionCommandPlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    PercisionCommandPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    PercisionCommandPlugin_destroy_sample;
    ...
    plugin->getSampleFnc =
    (PRESTypePluginGetSampleFunction)
    PercisionCommandPlugin_get_sample;
    plugin->returnSampleFnc =
    (PRESTypePluginReturnSampleFunction)
    PercisionCommandPlugin_return_sample;
    ...
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    PercisionCommandPlugin_get_key_kind;
    ...
    */
    ...
    plugin->serializedKeyToKeyHashFnc = NULL;    
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &rti::topic::dynamic_type<PercisionCommand>::get().native();
    ...
    plugin->getBuffer = 
    (PRESTypePluginGetBufferFunction)
    PercisionCommandPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    PercisionCommandPlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    PercisionCommandPlugin_get_serialized_sample_size;

    static const char * TYPE_NAME = "PercisionCommand";
    plugin->endpointTypeName = TYPE_NAME;
...
void
PercisionCommandPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
...
{
    try {
        HumidityInfo *sample = new HumidityInfo;    
        rti::topic::allocate_sample(*sample);
        return sample;
    } catch (...) {
        return NULL;
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            endpoint_info,
            (PRESTypePluginDefaultEndpointDataCreateSampleFunction)
            HumidityInfoPluginSupport_create_data,
            (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
            HumidityInfoPluginSupport_destroy_data,
            NULL , NULL );
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = HumidityInfoPlugin_get_serialized_sample_max_size(
                epd,RTI_FALSE,RTI_CDR_ENCAPSULATION_ID_CDR_BE,0);
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                endpoint_info,
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                HumidityInfoPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
...
HumidityInfoPlugin_copy_sample(
    ...
    const HumidityInfo *src)
{
    return HumidityInfoPluginSupport_copy_data(dst,src);
}
    ...
    const HumidityInfo *sample)
{
    try{
        ...
        result = HumidityInfoPlugin_serialize(
            (PRESTypePluginEndpointData)&epd, sample, &stream, 
            RTI_TRUE, RTICdrEncapsulation_getNativeCdrEncapsulationId(), 
            RTI_TRUE, NULL);  
    ...
    unsigned int length)
{
    ...
    rti::topic::reset_sample(*sample);
    return HumidityInfoPlugin_deserialize_sample( 
        NULL, sample,
        &stream, RTI_TRUE, RTI_TRUE, 
        NULL);
}
    ...
    void *endpoint_plugin_qos)
{
    try {
        RTIBool result;
        const char *METHOD_NAME = "HumidityInfoPlugin_deserialize";
        if (drop_sample) {} /* To avoid warnings */

        stream->_xTypesState.unassignable = RTI_FALSE;
        result= HumidityInfoPlugin_deserialize_sample( 
            endpoint_data, (sample != NULL)?*sample:NULL,
            stream, deserialize_encapsulation, deserialize_sample, 
            endpoint_plugin_qos);
        if (result) {
...
RTIBool HumidityInfoPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
    RTIBool skip_encapsulation,
    RTIBool skip_sample, 
    ...
    unsigned int current_alignment)
{
    try {
        ...
        size = HumidityInfoPlugin_get_serialized_sample_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
    ...
    void *endpoint_plugin_qos)
{
    try {
        ...
        if(serialize_key) {
            ...
            if (!HumidityInfoPlugin_serialize(
                endpoint_data,
                sample,
                stream,
                RTI_FALSE, encapsulation_id,
...
RTIBool HumidityInfoPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    HumidityInfo *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
    ...
    void *endpoint_plugin_qos)
{
    try {
        ...
        if (deserialize_key) {
            ...
            if (!HumidityInfoPlugin_deserialize_sample(
                endpoint_data, sample, stream, 
                RTI_FALSE, RTI_TRUE, 
                endpoint_plugin_qos)) {
                return RTI_FALSE;
...
RTIBool HumidityInfoPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    HumidityInfo **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
    ...
    void *endpoint_plugin_qos)
{
    try {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= HumidityInfoPlugin_deserialize_key_sample(
            endpoint_data, (sample != NULL)?*sample:NULL, stream,
            deserialize_encapsulation, deserialize_key, endpoint_plugin_qos);
        if (result) {
            if (stream->_xTypesState.unassignable) {
    ...
    unsigned int current_alignment)
{
    ...
    current_alignment += HumidityInfoPlugin_get_serialized_sample_max_size_ex(
        endpoint_data, overflow,RTI_FALSE, encapsulation_id, current_alignment);
    ...
    unsigned int current_alignment)
{
    try {
        ...
        size = HumidityInfoPlugin_get_serialized_key_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
...
* Plug-in Installation Methods
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *HumidityInfoPlugin_new(void) 
{ 
    struct PRESTypePlugin *plugin = NULL;
    const struct PRESTypePluginVersion PLUGIN_VERSION = 
    PRES_TYPE_PLUGIN_VERSION_2_0;
    ...
    plugin->createSampleFnc =
    (PRESTypePluginCreateSampleFunction)
    HumidityInfoPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    HumidityInfoPlugin_destroy_sample;
    ...
    plugin->getKeyKindFnc =
    (PRESTypePluginGetKeyKindFunction)
    HumidityInfoPlugin_get_key_kind;
    ...
    */
    ...
    plugin->serializedKeyToKeyHashFnc = NULL;    
    plugin->typeCode = (struct RTICdrTypeCode *) 
    &rti::topic::dynamic_type<HumidityInfo>::get().native();
    ...
    plugin->getBuffer = 
    (PRESTypePluginGetBufferFunction)
    HumidityInfoPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    HumidityInfoPlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    HumidityInfoPlugin_get_serialized_sample_size;

    static const char * TYPE_NAME = "HumidityInfo";
    plugin->endpointTypeName = TYPE_NAME;
...
void
HumidityInfoPlugin_delete(struct PRESTypePlugin *plugin)
{
    RTIOsapiHeap_freeStructure(plugin);
} 
